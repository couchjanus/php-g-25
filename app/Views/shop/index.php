          ...
          <div class="container p-0">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                <a href="#!" class="anchor categories"><h5 class="text-uppercase mb-4 py-2 px-4 bg-dark text-white mb-3 d-flex justify-content-between"><strong class="small text-uppercase fw-bold">All Categories</strong> <strong class="small fw-bold all-categories"></strong></h5></a>
                
                <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal categories-list"></ul>
              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                <div class="row mb-3 align-items-center">
                  ...
                  <div class="col-lg-6">
                    <select class="selectpicker form-select form-select-lg mb-2 text-sm text-muted">
